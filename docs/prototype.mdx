...
A unit of the functional prototype was assembled using the custom printed circuit board and a 3-D printed enclosure for characterization under low-flow conditions (Fig. 5). Characterization results are presented on the next page.
