...
A unit of the functional prototype was built using the custom printed circuit board and a 3-D printed enclosure for characterization (Fig. 5).
...
Next, we characterized real-world issues (Fig. 7).
...
**Fig. 7**: Characterization of nose-vs-mouth breathing (above) and a patient cough test (below).

</figcaption>
</figure>

[<Button>&laquo; Design</Button>](design) [<Button>Contributing &raquo;</Button>](contributing)
